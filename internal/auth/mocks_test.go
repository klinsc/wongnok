...
func (_mock *MockIService) VerifyToken(ctx context.Context, tokenString string) (*oidc.IDToken, error) {
...
//   - ctx context.Context
//   - tokenString string
func (_e *MockIService_Expecter) VerifyToken(ctx interface{}, tokenString interface{}) *MockIService_VerifyToken_Call {
	return &MockIService_VerifyToken_Call{Call: _e.mock.On("VerifyToken", ctx, tokenString)}
}

func (_c *MockIService_VerifyToken_Call) Run(run func(ctx context.Context, tokenString string)) *MockIService_VerifyToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockIService_VerifyToken_Call) Return(iDToken *oidc.IDToken, err error) *MockIService_VerifyToken_Call {
	_c.Call.Return(iDToken, err)
	return _c
}

func (_c *MockIService_VerifyToken_Call) RunAndReturn(run func(ctx context.Context, tokenString string) (*oidc.IDToken, error)) *MockIService_VerifyToken_Call {
	_c.Call.Return(run)
	return _c
}
